...
var runAllQuery = function () {
	...
	[
		...
		"create table if not exists booksStatus(id varchar primary key, book_name varchar2(50), available integer, takenBy varchar, foreign key(takenBy) references users(u_id));",
